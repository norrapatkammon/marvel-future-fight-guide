...
export const tierLabels: Record<CtpTier, LocaleText> = {
  ...
  brilliant: { th: "เปล่งประกราย", en: "Brilliant" },
};

const mightyAcquisition: LocaleText[] = [
  {
    th: "C.T.P. Reforging Normal Success",
...
const brilliantAcquisition: LocaleText[] = [
  {
    th: "C.T.P. Reforging Super Success",
...
export const ctps: Ctp[] = [
  {
    ...
    reforgedNote: {
      th: "เอฟเฟกต์ Enraged เพิ่มดาเมจ แต่คุ้ม reforge เมื่ออยากสแตกตัวใดตัวหนึ่งจริงๆ ไม่เช่นนั้น Rage ธรรมดา 2 ใบมักคุ้มกว่า Mighty 1 ใบ",
      en: "The Enraged effect adds more damage, but is likely only worth Reforging if you really want to stack a particular character. Otherwise, two regular Rages provides more value than one Mighty.",
    },
    tiers: makeTiers({
      ...
      regularStats: [
        ...
        line(
          "ปริมาณความเสียหายทั่วไปเพิ่มขึ้น {0}% ต่ออัตราคริติคอล, อัตราหลบหลีก 1% โดยไม่เกี่ยวข้องกับอัตราคริติคอลแน่นอนหรืออัตราหลบหลีกแน่นอน({1} วิ)",
          "Increases all damage by {0}% per 1% Critical Rate and Dodge Rate, regardless of Guaranteed Critical Rate or Guaranteed Dodge Rate ({1} sec.)",
          ["0.9", "5"],
        ),
        line(
          "เพิกเฉยอัตราลดปริมาณความเสียหายของบอส เทียบเท่า {0}%({1} วิ)",
          "Ignores Boss's Damage Decrease by {0}% ({1} sec.)",
          ["60", "5"],
        ),
        line("ใช้ได้ภายใน {0} วิ", "Cooldown Time {0} seconds", ["7"]),
      ],
      ...
      mightyReforge: {
        specialName: { th: "Enraged", en: "Enraged" },
        specialLines: [
          line(
            "เพิ่มความเสียหายคริติคอล {0}% โดยไม่จำกัดค่าสูงสุด ความเสียหายคริติคอลเพิ่มเติม +{1}% ({2} วิ)",
            "Increases Critical Damage by {0}%, regardless of the max limit. Additional Critical Damage +{1}% ({2} sec.)",
            ["200", "40", "6"],
          ),
        ...
        genericLines: [
          line(
            ...
            "Increases All Attacks and Defenses by {0}%",
            ["20"],
          ),
        ],
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge ช่วยเพิ่มศักยภาพ burst แต่ควร reforge เมื่อตัวนั้นเป็นตัวหลักของโหมดสำคัญ",
      en: "Reforging boosts burst potential, but is best reserved for a mode-defining main damage dealer.",
    },
    tiers: makeTiers({
      ...
      regularStats: [
        ...
        line(
          ...
          "Increases all damage of 1 attack by {0}% ({1} sec.)",
          ["200", "5"],
        ),
      ...
      brilliantStats: [
        line("ไม่สนใจการหลบหลีก {0}%", "Ignore Dodge {0}%", ["51.8"]),
        line("เพิ่มความเสียหายคริติคอล +{0}%", "Critical Damage +{0}%", ["51.8"]),
        line(
          "โอกาสเกิด : เมื่อโจมตี ด้วยอัตรา {0}%",
          "Activation Rate: {0}% chance when attacking",
          ["12"],
      ...
      brilliantMax: ["51.8", "51.8", "12", "36", "240"],
      mightyReforge: {
        specialName: { th: "Overcharge", en: "Overcharge" },
        specialLines: [
          line(
            "ความเสียหายทั่วไปของ 1 การโจมตี เพิ่มขึ้นเพิ่มเติม {0}%({1} วิ)",
            "Increases Damage by an additional {0}% for 1 attack ({1} sec.)",
            ["100", "5"],
          ),
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge คุ้มเมื่อตัวธาตุนั้นเป็นตัวหลักหลายโหมด",
      en: "Worth reforging when the elemental hero is a multi-mode main.",
    },
    tiers: makeTiers({
      regularAcquisition: acqSpecialGearChest,
      regularStats: [
        ...
        line(
          "ใช้กับ : ศัตรู → พลังต้านทานทั้งหมดลดลง -{0}% ({1} วิ)",
          "Applies to: Enemy → Decreases All Resistances by -{0}% ({1} sec.)",
          ["30", "5"],
        ),
        line(
          "ใช้กับ : ตัวเอง → อัตราความเสียหายโจมตีทั้งหมดเพิ่มขึ้น +{0}% ({1} วิ)",
          "Applies to: Self → Increases All Attack Damage by +{0}% ({1} sec.)",
          ["200", "5"],
        ),
        line("ใช้ถัดไปใน {0} วิ", "Cooldown Time {0} seconds", ["7"]),
      ],
      ...
      brilliantMax: ["36.8", "24", "12", "36", "240"],
      mightyReforge: {
        specialName: { th: "Verdict", en: "Verdict" },
        specialLines: [
          line(
            "อัตราความเสียหายโจมตีทั้งหมดเพิ่มขึ้นเพิ่มเติม +{0}% ({1} วิ)",
            "Further increases All Attack Damage by {0}% ({1} sec.)",
            ["80", "5"],
          ),
          line("ใช้ถัดไปใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
        genericLines: [
          line(
            "เพิ่มพลังโจมตี, พลังป้องกันทั่วไปทั้งหมด +{0}%",
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge (โดยเฉพาะ Fury) ช่วยมาก แต่ใส่ได้ผลดีแม้ยังไม่ reforge ถ้าตัวเป็น T4",
      en: "Reforge (especially Fury) helps a lot, but it is already strong unreforged on a real T4.",
    },
    tiers: makeTiers({
      regularAcquisition: acqSpecialGearChest,
      regularStats: [
        line(
          "อัตราคริติคอล / อัตราคริติคอลแน่นอน +{0}%",
          "Critical Rate / Guaranteed Critical Rate +{0}%",
          ["34"],
        ),
        line("เพิ่มความเสียหายคริติคอล +{0}%", "Critical Damage +{0}%", ["45"]),
        line(
        ...
        line("ใช้กับ : ตัวเอง", "Applies to: Self"),
        line(
          "เพิ่มความเสียหายต่อประเภทบอส {0}% ของสัญชาตญาณ (สูงสุด {1}%) ({2} วิ)",
          "Increases damage to Boss type by {0}% of Instinct (max {1}%) ({2} sec.)",
          ["6", "140", "6"],
        ),
        line(
          "เพิกเฉยอัตราลดปริมาณความเสียหายของบอส เทียบเท่า {0}%({1} วิ)",
      ...
      brilliantMax: ["39.1", "51.8", "18", "160", "62"],
      mightyReforge: {
        specialName: { th: "Fury", en: "Fury" },
        specialLines: [
          line(
            "เพิ่มเอฟเฟกต์ความเสียหายที่เกี่ยวกับสัญชาตญาณ {0}% ({1} วิ)",
            "Increases Instinct-related damage effects by {0}% ({1} sec.)",
            ["40", "6"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge ช่วยเพิ่ม burst window — คุ้มเมื่อตัวนั้นพึ่งสกิลหนักเป็นหลัก",
      en: "Reforging improves the burst window — worth it on heavy skill-window dealers.",
    },
    tiers: makeTiers({
      regularAcquisition: acqSpecialGearChest,
      regularStats: [
        ...
        line(
          ...
          "{0}% chance to pierce Super Armor, Guard, All Damage Immunity, and Invincibility ({1} sec.)",
          ["30", "5"],
        ),
        line(
          "ความเสียหายทั่วไปของ 1 การโจมตี เพิ่มขึ้น {0}% ({1} วิ)",
      ...
      brilliantMax: ["51.8", "12", "36", "240"],
      mightyReforge: {
        specialName: { th: "Ruin", en: "Ruin" },
        specialLines: [
          line(
            "เพิ่มเอฟเฟกต์เจาะทะลุ {0}% ({1} วิ)",
            "Increases pierce effects by {0}% ({1} sec.)",
            ["40", "5"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge มีค่าเมื่อตัวนั้นเป็นสไตรเกอร์หรือคอนโทรลหลักใน Timeline/PvP",
      en: "Reforge is valuable when the hero is a primary Timeline/PvP striker or controller.",
    },
    tiers: makeTiers({
      regularAcquisition: acqSpecialGearChest,
      regularStats: [
        ...
        line(
          ...
          "Increases All Attack by +{0}% per 1% true damage taken ({1} sec.)",
          ["5", "7"],
        ),
        line(
      ...
      brilliantMax: ["51.8", "50", "5", "6", "12"],
      mightyReforge: {
        specialName: { th: "Dominion", en: "Dominion" },
        specialLines: [
          line(
            "เพิ่มพลังโจมตีจากความเสียหายจริงเพิ่มเติม +{0}% ({1} วิ)",
            "Additional All Attack amplification from true damage +{0}% ({1} sec.)",
            ["40", "5"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge ช่วยเกราะ/ฮีลให้แข็งขึ้น คุ้มกับตัวที่ต้องรับสกิลเปิดไฟต์",
      en: "Reforge strengthens the heal/guard package — worth it on opening-skill tanks.",
    },
    tiers: makeTiers({
      regularAcquisition: acqSpecialGearChest,
      regularStats: [
        ...
        line(
          ...
          "Max that ignores pierce and removal (Protects against Damage Instinct) ({0} sec.)",
          ["5"],
        ),
        line("ใช้ได้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
      ],
      ...
      brilliantStats: [
        ...
        line("ใช้กับ : ตัวเอง", "Applies to: Self"),
        line("ฟื้นฟู HP {0}% เพิ่มขึ้น", "Recovers {0}% HP", ["12"]),
        line("สร้างโล่ {0}% ของ HP", "Creates a shield of {0}% of HP", ["42"]),
        line(
          "สูงสุดที่เพิกเฉยเจาะทะลุและการลบออก (ป้องกันสัญชาตญาณความเสียหาย)({0} วิ)",
          "Max that ignores pierce and removal (Protects against Damage Instinct) ({0} sec.)",
          ["5"],
      ...
      brilliantMax: ["39.1", "100", "50", "12", "42"],
      mightyReforge: {
        specialName: { th: "Renewal", en: "Renewal" },
        specialLines: [
          line(
            "ฟื้นฟู HP เพิ่มเติม {0}% และเพิ่มความแข็งแกร่งของโล่ ({1} วิ)",
            "Additional Max HP recovery {0}% and barrier strength up ({1} sec.)",
            ["10", "6"],
          ),
          line("ใช้ได้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["11"]),
        ],
        genericLines: [
          line(
            "เพิ่มพลังโจมตี, พลังป้องกันทั่วไปทั้งหมด +{0}%",
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge ช่วยในไฟต์ยาว คุ้มกับตัวเปิดเกมและ mid-fight tank",
      en: "Reforge helps in longer fights — good on openers and mid-fight tanks.",
    },
    tiers: makeTiers({
      regularAcquisition: acqSpecialGearChest,
      regularStats: [
        ...
        line(
          "กำแพงป้องกัน (ลดความเสียหายที่ได้รับ {0}%, อัตราลดความเสียหายทุกครั้งที่โดนโจมตีลดลง {1}%, อัตราลดความเสียหายต่ำสุด {2}%)({3} วิ)",
          "Barrier (Decreases damage taken by {0}%, reduction decreases by {1}% each hit received, minimum reduction {2}%) ({3} sec.)",
          ["80", "3", "60", "6"],
        ),
      ...
      brilliantStats: [
        line("ใช้กับ : ตัวเอง", "Applies to: Self"),
        line("ป้องกันการ์ดเบรค", "Guard Break Immunity"),
        line("เพิ่มอัตราฟื้นฟู +{0}%", "Recovery Rate +{0}%", ["100"]),
        line(
          "โอกาสเกิด : เมื่อมี HP น้อยกว่า {0}%",
          "Activation Rate: when HP is below {0}%",
          ["50"],
      ...
      brilliantMax: ["100", "50", "12", "24", "85"],
      mightyReforge: {
        specialName: { th: "Siege", en: "Siege" },
        specialLines: [
          line(
            "เพิ่มความแข็งแกร่งของกำแพงป้องกัน {0}% ({1} วิ)",
            "Increases barrier strength by {0}% ({1} sec.)",
            ["40", "5"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  {
    id: "insight",
    name: { th: "C.T.P. แห่งความเข้าใจ", en: "C.T.P. of Insight" },
    category: "support",
    focus: "hybrid",
    accent: "#06b6d4",
    description: {
    ...
    reforgedNote: {
      th: "Reforge เป็นของหรู แต่ Insight ธรรมดาก็คุ้มใส่ซัพพอร์ตหลายโหมดแล้ว",
      en: "Reforge is a luxury — regular Insight is already great on multi-mode supports.",
    },
    tiers: makeTiers({
      regularAcquisition: acqSpecialGearChest,
      regularStats: [
        ...
        line(
          ...
          "Increases all damage dealt to Super Villains by {0}% ({1} sec.)",
          ["20", "5"],
        ),
        line(
          "ความเสียหายทั่วไปที่มอบแก่ฝ่าย ฮีโร่ เพิ่มขึ้น {0}%({1} วิ)",
          "Increases all damage dealt to Heroes by {0}% ({1} sec.)",
          ["20", "5"],
        ),
        line(
      ...
      brilliantMax: ["39.1", "44.9", "12", "24", "24"],
      mightyReforge: {
        specialName: { th: "Clarity", en: "Clarity" },
        specialLines: [
          line(
            "เพิ่มความแรงของบัฟทีม {0}% ({1} วิ)",
            "Team buff potency increased by {0}% ({1} sec.)",
            ["20", "6"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  },
  {
    ...
    tiers: makeTiers({
      ...
      regularStats: [
        ...
        line(
          "เพิ่มพลังโจมตี, พลังป้องกันทั่วไปทั้งหมด +{0}%",
          "Increases All Attack and All Defense by +{0}%",
          ["28"],
        ),
        line(
          "โอกาสเกิด : เมื่อโจมตี ด้วยอัตรา {0}%",
      ...
      brilliantMax: ["100", "32.2", "12", "24"],
      mightyReforge: {
        specialName: { th: "Emancipation", en: "Emancipation" },
        specialLines: [
          line(
            "เพิ่มดาเมจต่อสัญชาตญาณเพิ่มเติม +{0}% ({1} วิ)",
            "Additional Instinct damage +{0}% ({1} sec.)",
            ["15", "6"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge ช่วยเกราะอยู่รอด — เหมาะกับแทงก์และตัวเปิดไฟต์",
      en: "Reforge improves the survival shell — good on tanks and openers.",
    },
    tiers: makeTiers({
      ...
      regularStats: [
        ...
        line("ใช้ซ้ำภายใน {0} วิ", "Cooldown Time {0} seconds", ["15"]),
      ],
      ...
      brilliantStats: [
        ...
        line("ใช้กับ : ตัวเอง", "Applies to: Self"),
        line("ฟื้นฟู HP {0}% เพิ่มขึ้น", "Recovers {0}% HP", ["24"]),
        line("ที่กั้น ({0} ครั้ง)({1} วิ)", "Guard ({0} hits) ({1} sec.)", [
          "7",
          "6",
        ]),
      ...
      brilliantMax: ["39.1", "100", "50", "24", "7"],
      mightyReforge: {
        specialName: { th: "Polish", en: "Polish" },
        specialLines: [
          line(
            "ฟื้นฟู HP เพิ่มเติม {0}% ({1} วิ)",
            "Additional recovery {0}% of Max HP ({1} sec.)",
            ["8", "6"],
          ),
          line("ใช้ซ้ำภายใน {0} วิ", "Cooldown Time {0} seconds", ["11"]),
        ],
        genericLines: [
          line(
            "เพิ่มพลังโจมตี, พลังป้องกันทั่วไปทั้งหมด +{0}%",
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge ช่วยให้เกราะแน่นขึ้นใน PvP ที่สกิลเปิดไฟต์แรง",
      en: "Reforge helps tank the strongest PvP opening skills.",
    },
    tiers: makeTiers({
      ...
      brilliantMax: ["36.8", "36.8", "50", "50", "5"],
      mightyReforge: {
        specialName: { th: "Endure", en: "Endure" },
        specialLines: [
          line(
            "ลดความเสียหายจากสะท้อนกลับเพิ่มเติม {0}% ({1} วิ)",
            "Additional reflect damage taken reduction {0}% ({1} sec.)",
            ["15", "5"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge ช่วยสแตกดาเมจประเภทให้ตัว carry PvP",
      en: "Reforge helps stack type damage for PvP carries.",
    },
    tiers: makeTiers({
      regularAcquisition: acqSpecialGearChest,
      regularStats: [
        ...
        line(
          ...
          "Increases all damage dealt to Combat and Blast types by {0}% ({1} sec.)",
          ["150", "5"],
        ),
        line(
          "เพิ่มความเสียหายทั่วไปที่มอบให้ประเภท ความเร็ว, สากล ขึ้น {0}%({1} วิ)",
          "Increases all damage dealt to Speed and Universal types by {0}% ({1} sec.)",
          ["150", "5"],
        ),
        line(
      ...
      brilliantMax: ["12", "180", "180", "12"],
      mightyReforge: {
        specialName: { th: "Avarice", en: "Avarice" },
        specialLines: [
          line(
            "เพิ่มดาเมจประเภทเพิ่มเติม +{0}% ({1} วิ)",
            "Additional type damage +{0}% ({1} sec.)",
            ["50", "5"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  },
  {
    ...
    reforgedNote: {
      th: "Reforge คุ้มกับตัวที่มี self-sustain หรือมักรบใกล้เลือดต่ำ",
      en: "Worth reforging on self-sustaining heroes that often fight near low HP.",
    },
    tiers: makeTiers({
      regularAcquisition: acqHiddenTicket,
      regularStats: [
        line("พลังโจมตีทั้งหมดเพิ่มขึ้น +{0}%", "All Attack +{0}%", ["32"]),
        line("ไม่สนใจการหลบหลีก {0}%", "Ignore Dodge {0}%", ["45"]),
        line(
          "โอกาสเกิด : เมื่อมี HP น้อยกว่า {0}%",
          "Activation Rate: when HP is below {0}%",
      ...
      brilliantStats: [
        line("พลังโจมตีทั้งหมดเพิ่มขึ้น +{0}%", "All Attack +{0}%", ["36.8"]),
        line("ไม่สนใจการหลบหลีก {0}%", "Ignore Dodge {0}%", ["51.8"]),
        line(
          "โอกาสเกิด : เมื่อมี HP น้อยกว่า {0}%",
          "Activation Rate: when HP is below {0}%",
      ...
      brilliantMax: ["36.8", "51.8", "50", "50", "5"],
      mightyReforge: {
        specialName: { th: "Ascend", en: "Ascend" },
        specialLines: [
          line(
            "เพิ่มระยะเวลาอมตะ/สะท้อนเพิ่มเติม และพลังโจมตี +{0}% ({1} วิ)",
            "Additional All Attack +{0}% while active ({1} sec.)",
            ["25", "6"],
          ),
          line("ใช้ได้ภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
  ...
  },
  {
    ...
    reforgedNote: {
      th: "ใช้เป็นตัวเลือกชั่วคราวได้ดี และ reforge ก็ช่วยให้ใช้งานได้นานขึ้น",
      en: "A solid stopgap that becomes more permanent once reforged.",
    },
    tiers: makeTiers({
      regularAcquisition: acqCollectorsRoom,
      regularStats: [
        line(
          "ป้องกันการ์ดเบรค, เพิกเฉยหลบหลีก, เพิ่มอัตราความเสียหายคริติคอล +{0}%",
      ...
      brilliantStats: [
        ...
        line("สร้างโล่ {0}% ของ HP", "Creates a shield of {0}% of HP", ["36"]),
        line(
          "สูงสุดที่เพิกเฉยเจาะทะลุและการลบออก (ป้องกันสัญชาตญาณความเสียหาย)({0} วิ)",
          "Max that ignores pierce and removal (Protects against Damage Instinct) ({0} sec.)",
          ["3"],
      ...
      brilliantMax: ["36.8", "32.2", "18", "48", "180"],
      mightyReforge: {
        specialName: { th: "Experience", en: "Experience" },
        specialLines: [
          line(
            "เพิ่มความแรงของเอฟเฟกต์ยูทิลิตี้ +{0}% ({1} วิ)",
            "Utility effect potency +{0}% ({1} sec.)",
            ["15", "6"],
          ),
          line("ใช้อีกภายใน {0} วิ", "Cooldown Time {0} seconds", ["10"]),
        ],
